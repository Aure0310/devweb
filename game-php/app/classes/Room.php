    ...
    public function getHTML(): string
    {
       $html = "";
        ...
        switch ($this->type) {
            ...
            case 'treasure':
                $html .= "<p class='mt-4'>Vous avez gagné " . $this->or . " pièce(s) d'or</p>";
                $html .= "<p class='mt-4'><a href='donjon_play.php?id=". $this->donjon_id ."' class='btn btn-green'>Continuer l'exploration</a></p>";
                break;
            
            case 'combat':
                $html .= "<p class='mt-4'><a href='donjon_fight.php?id=". $this->donjon_id ."' class='btn btn-green'>Combattre</a></p>";
                $html .= "<a href='donjon_play.php?id=". $this->donjon_id ."' class='btn btn-green'>Fuir et continuer l'exploration</a>";
                break;
