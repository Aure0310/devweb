<?php
    ...
    if ($_SESSION['fight']['ennemi']->speed > $_SESSION['perso']['vit']) {
        $_SESSION['fight']['html'][] = $ennemi->name . 'Il a plus de vitesse ! Il tape en premier !';
        
        $touche = random_int(0, 20);
        $_SESSION['fight']['html'][] = $touche;

        if ($touche >= 10) {
            $_SESSION['fight']['html'][] = "Il vous a touché !";
            $degat = random_int(0, $_SESSION['fight']['ennemi']->power) + floor($_SESSION['fight']['ennemi']->power/3);
            $_SESSION['fight']['html'][] = "Vous perdez " . ($degat - floor($_SESSION['perso']['for']/3)) . " point(s) de vie";
            $_SESSION['perso']['pdv'] -=  $degat - floor($_SESSION['perso']['for']/3);
        } else {
            $_SESSION['fight']['html'][] = "Il vous a raté.";
        }
        ...
        $_SESSION['fight']['html'][] = $_SESSION['perso']['name'] . 'Vous êtes plus rapide ! Vous tapez en premier';
        ...
        if ($touche >= 10) {
            $_SESSION['fight']['html'][] = "Vous touchez votre ennemi.";
            $degat = random_int(0,10) + floor($_SESSION['perso']['for']/3);
            $_SESSION['fight']['html'][] = "Vous perdez " . ($degat - floor($_SESSION['fight']['ennemi']->constitution/3)) . " point(s) de vie";
            $_SESSION['fight']['ennemi']->pol -=  $degat - floor($_SESSION['fight']['ennemi']->constitution/3);
            ...
            if ($_SESSION['fight']['ennemi']->pol <= 0) {
                ...
                if ($touche >= 10) {
                    ...
                    $_SESSION['fight']['html'][] = "Vous êtes très habile ! Votre ennemi vous a raté !";
                }
            }
        } else {
            $_SESSION['fight']['html'][] = "Vous ratez votre ennemi.";
            ...
            if ($touche >= 10) {
                ...
                $_SESSION['fight']['html'][] = "Votre ennemi vous a raté.";
            }
        }
    }
    ...
    require_once('_headercombat.php');
?>
    <div class="container">
        <div class="row mt-4">
            <div class="px-4">
